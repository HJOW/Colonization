...
public class DefaultColonyManagerConfig implements ColonyManagerConfig {
    ...
    public DefaultColonyManagerConfig() { }
    ...
    public ColonyManagerConfig getMap(String key) {
        ...
        if(obj instanceof Map<?, ?>) {
            ColonyManagerConfig child = new DefaultColonyManagerConfig();
            ...
            for(Object k : keys) {
                ...
                if(child instanceof DefaultColonyManagerConfig) ((DefaultColonyManagerConfig) child).getRoots().put(k.toString(), val);
            }
            return child;
        } else {
    ...
    public ColonyManagerConfig cloneSelf() {
    	DefaultColonyManagerConfig newInst = new DefaultColonyManagerConfig();
