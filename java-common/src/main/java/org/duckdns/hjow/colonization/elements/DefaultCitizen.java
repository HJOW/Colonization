...
/** 시민 구현 클래스 */
public class DefaultCitizen implements Citizen {
    ...
    public DefaultCitizen() { super(); }
    public DefaultCitizen(long age) { this(); this.age = new BigInteger(String.valueOf(age)); }
    public DefaultCitizen(JsonObject json) {
        this();
        fromJson(json);
    }
