...
public class DefaultLoan implements Loan {
    ...
    public DefaultLoan() {}
    public DefaultLoan(long amount, int interestCount, int interestRate100) {
        this();
    ...
    public static List<Loan> makeAvailableLoanListRandom(Colony col) {
        ...
        for(int idx=0; idx<offerCount; idx++) {
            ...
            // 상품 생성
            Loan loan = new DefaultLoan(amount, interestCnt, interestStd + (int) ((ColonyManager.random() * interestStd) / 2.0) );
